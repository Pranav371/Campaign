...
// ========================================
const CONFIG = {
    // Campaign details - Tekulapalli Gram Panchayat
    candidateName: 'రవికిషోర్ సాయిని',
    gramPanchayat: 'టేకులపల్లి',
    electionDate: 'డిసెంబర్ 2025',
    websiteUrl: window.location.href,

    // WhatsApp message template (Telugu) with Ward Members
    whatsappMessage: `🗳️ *టేకులపల్లి గ్రామ పంచాయతీ సర్పంచ్ ఎన్నికలు 2025*
...
👥 *మద్దతు ఇస్తున్న వార్డు సభ్యులు:*
• వార్డు 3 - రవికిషోర్ సాయిని 🪑
• వార్డు 4 - మల్లేష్ కొమ్మ 🔥
• వార్డు 5 - బండారి రామక్క
• వార్డు 6 - సువర్ణ పోలవేణి
• వార్డు 7 - మల్లేష్ కొమ్మ
• వార్డు 8 - పుట్ట రాజేశ్వరి

📅 పోలింగ్ తేదీ: డిసెంబర్ 2025
